...
"border-radius:15px;")
        ...
        self.dateToday = QtWidgets.QDateTimeEdit(self.centralwidget)
        self.dateToday.setGeometry(QtCore.QRect(100, 50, 194, 26))
        self.dateToday.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.dateToday.setStyleSheet("font: 12pt \"Arial\";\n"
"")
        self.dateToday.setAlignment(QtCore.Qt.AlignCenter)
        self.dateToday.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.dateToday.setSpecialValueText("")
        self.dateToday.setProperty("showGroupSeparator", False)
        ...
        self.sex.activated.connect(self.selected)
        self.sex.setGeometry(QtCore.QRect(210, 300, 88, 26))
        self.sex.setStyleSheet("font: 12pt \"Arial\";")
        ...
        self.sex.addItem("")
        self.sex.addItem("")
        self.dateofDeath = QtWidgets.QDateTimeEdit(self.centralwidget)
        self.dateofDeath.setGeometry(QtCore.QRect(440, 300, 141, 26))
        self.dateofDeath.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.dateofDeath.setStyleSheet("font: 12pt \"Arial\";\n"
"")
        self.dateofDeath.setAlignment(QtCore.Qt.AlignCenter)
        self.dateofDeath.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.dateofDeath.setSpecialValueText("")
        self.dateofDeath.setProperty("showGroupSeparator", False)
        self.dateofDeath.setObjectName("dateofDeath")
        ...
        self.causeofdeath.setInputMask("")
        ...
        self.nameofCemetery.setInputMask("")
        self.nameofCemetery.setAlignment(QtCore.Qt.AlignCenter)
        self.nameofCemetery.setObjectName("nameofCemetery")
        self.infectious = QtWidgets.QComboBox(self.centralwidget)
        self.infectious.activated.connect(self.selected)
        self.infectious.setGeometry(QtCore.QRect(310, 420, 721, 26))
        self.infectious.setStyleSheet("font: 12pt \"Arial\";")
        self.infectious.setEditable(False)
        self.infectious.setObjectName("infectious")
        self.infectious.addItem("")
        self.infectious.setItemText(0, "")
        self.infectious.addItem("")
        self.infectious.addItem("")
        self.embalming = QtWidgets.QComboBox(self.centralwidget)
        self.embalming.activated.connect(self.selected)
        self.embalming.setGeometry(QtCore.QRect(350, 460, 681, 26))
        self.embalming.setStyleSheet("font: 12pt \"Arial\";")
        self.embalming.setEditable(False)
        self.embalming.setObjectName("embalming")
        self.embalming.addItem("")
        self.embalming.setItemText(0, "")
        self.embalming.addItem("")
        self.embalming.addItem("")
        self.embalming.addItem("")
        self.disposition = QtWidgets.QComboBox(self.centralwidget)
        self.disposition.activated.connect(self.selected)
        self.disposition.setGeometry(QtCore.QRect(250, 500, 781, 26))
        self.disposition.setStyleSheet("font: 12pt \"Arial\";")
        self.disposition.setEditable(False)
        self.disposition.setObjectName("disposition")
        self.disposition.addItem("")
        self.disposition.setItemText(0, "")
        self.disposition.addItem("")
        self.disposition.addItem("")
        self.amount = QtWidgets.QLineEdit(self.centralwidget)
        self.amount.setGeometry(QtCore.QRect(410, 540, 81, 26))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.collectingOfficer.setInputMask("")
        self.collectingOfficer.setAlignment(QtCore.Qt.AlignCenter)
        self.collectingOfficer.setReadOnly(False)
    ...
    def retranslateUi(self, BurialForm):
        ...
        self.dateToday.setDisplayFormat(_translate("BurialForm", "MM-dd-yyyy"))
        self.ref.setInputMask(_translate("BurialForm", "0000009"))
        self.age.setInputMask(_translate("BurialForm", "00"))
        self.sex.setItemText(1, _translate("BurialForm", "FEMALE"))
        self.sex.setItemText(2, _translate("BurialForm", "MALE"))
        self.dateofDeath.setDisplayFormat(_translate("BurialForm", "MM-dd-yyyy"))
        self.infectious.setItemText(1, _translate("BurialForm", "INFECTIOUS"))
        self.infectious.setItemText(2, _translate("BurialForm", "NON-INFECTIOUS"))
        self.embalming.setItemText(1, _translate("BurialForm", "BODY EMBALMED"))
        self.embalming.setItemText(2, _translate("BurialForm", "NOT EMBALMED"))
        self.embalming.setItemText(3, _translate("BurialForm", "INJECTION ONLY"))
        self.disposition.setItemText(1, _translate("BurialForm", "BURIAL"))
        self.disposition.setItemText(2, _translate("BurialForm", "CREMATION"))
    ...
    def user_input(self):
        if self.ref.text()=="":
                ...
                dateOfDeath = self.dateofDeath.date().toString("dd-MM-yyyy")
                dateToday = self.dateToday.date().toString("dd-MM-yyyy")
    ...
    def selected (self):
        global sex, infect, embalm, dispo
        sex= self.sex.currentText()
        infect = self.infectious.currentText()
        embalm = self.embalming.currentText()
        dispo = self.disposition.currentText()
